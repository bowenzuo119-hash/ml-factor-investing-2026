"""
Week 3 â€” Person C: Finalise Regime Model + Overlay Rules
=========================================================
Inputs:
  regime_features_monthly_2005_2024.csv   (from Week 1)
  regime_labels_final.csv                 (from Week 2 â€” used for comparison)

Outputs:
  regime_walkforward_labels.csv           â† the file Person A uses in Week 4
  regime_overlay_rules.csv                â† leverage scalar per month
  regime_walkforward_chart.png            â† train/test split visualisation
  week3_regime_summary.txt                â† written summary for report

What this script does (Days 15â€“21):
  Days 15â€“16: Walk-forward expanding-window regime prediction
              This is the RIGOROUS version â€” train on past, predict future.
              Fixes the look-ahead problem in Week 2's in-sample fitting.

  Days 17â€“18: Lock in final model based on walk-forward stability.
              Define and apply leverage overlay rules:
                calm   â†’ 1.00x  (full gross leverage)
                normal â†’ 1.00x  (full gross leverage)
                crisis â†’ 0.50x  (halve all position sizes)

  Days 19â€“21: Additional feature engineering to help Person B.
...
# Leverage overlay â€” simple is better (from the project brief)
REGIME_PARAM_MAP = {
    "calm": {
        "leverage": 1.00,
        "k_per_sector": 5,
...
try:
    ...
    has_week2 = True
    print(f"  âœ“ Week 2 labels loaded for comparison")
except FileNotFoundError:
    has_week2 = False
    print(f"  âš  Week 2 labels not found â€” skipping comparison")


# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# DAYS 15â€“16: WALK-FORWARD EXPANDING WINDOW
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
banner("DAYS 15â€“16 â€” Walk-Forward Expanding Window (Rigorous Train â†’ Predict)")

print(f"""
  WHY WALK-FORWARD MATTERS
  â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Week 2 fitted GMM/HMM on all 20 years at once, then evaluated
  on the same data. This is IN-SAMPLE â€” the model has already
  ...
  Walk-forward fixes this:
    Step 1 â†’ Train on months 1..60  (Jan 2005 â€“ Dec 2009)
    Step 2 â†’ Predict month 61       (Jan 2010)  â€” NEVER SEEN
    Step 3 â†’ Train on months 1..61
    Step 4 â†’ Predict month 62       (Feb 2010)
...
# â”€â”€ Helper: consistent regime labelling across models â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
def assign_labels(raw_labels, X_train_scaled, n_components, scaler):
    """
    Map integer cluster IDs â†’ regime names using VIX-level ordering.
    ...
    sorted_k = sorted(vix_means, key=vix_means.get)   # low â†’ high VIX
...
# â”€â”€ Walk-forward loop â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
for t in range(MIN_TRAIN_MONTHS, n_months):
    ...
    # Standardise ONLY on training data â€” critical!
...
print(f"\n  âœ“ Walk-forward complete. {n_months - MIN_TRAIN_MONTHS} out-of-sample predictions.")
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# DAYS 17â€“18: LOCK FINAL MODEL + OVERLAY RULES
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
banner("DAYS 17â€“18 â€” Lock Final Model + Define Overlay Rules")
...
def wf_crisis_score(labels, index, name):
    ...
    results = []
    print(f"\n  {name} â€” walk-forward crisis detection:")
    ...
    for start, end, label in STRESS_PERIODS:
        ...
        icon = "âœ“" if pct >= 50 else ("â–³" if pct >= 25 else "âœ—")
...
print(f"\n  â”€â”€ FINAL MODEL SELECTION â”€â”€")
for name, s in sorted(scores.items(), key=lambda x: -x[1]):
    bar  = "â–ˆ" * int(s / 5)
    star = " â† SELECTED" if name == best_name else ""
...
print(f"""
  â”€â”€ OVERLAY RULES (locked for Week 4) â”€â”€
  Regime       Leverage Scalar   Effect on portfolio
  â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€   â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€   â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  calm         {REGIME_PARAM_MAP['calm']['leverage']:.2f}x            Full gross (100L / 100S)
  normal       {REGIME_PARAM_MAP['normal']['leverage']:.2f}x            Full gross (100L / 100S)
  crisis       {REGIME_PARAM_MAP['crisis']['leverage']:.2f}x            Half gross (50L  / 50S)
...
# â”€â”€ regime_walkforward_labels.csv â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
out = pd.DataFrame({
    "regime_gmm2_wf":  wf_labels_gmm2,
    "regime_gmm3_wf":  wf_labels_gmm3,
    "regime_hmm2_wf":  wf_labels_hmm2,
    "regime_final_wf": final_labels_wf,   # â† Person A uses this column
}, index=months)
out.index.name = "month_end"

# Add full regime parameters alongside labels
param_series = out["regime_final_wf"].map(REGIME_PARAM_MAP)
param_df = pd.DataFrame(
    [p if isinstance(p, dict) else {} for p in param_series],
    index=out.index,
)

for col in ["leverage", "k_per_sector", "long_quantile", "short_quantile"]:
    out[col] = param_df.get(col, np.nan)

out.loc[
    out["regime_final_wf"] == "burn_in",
    ["leverage", "k_per_sector", "long_quantile", "short_quantile"]
] = np.nan
...
overlay_clean = out[
    ["regime_final_wf", "leverage", "k_per_sector", "long_quantile", "short_quantile"]
].copy()
overlay_clean = overlay_clean[overlay_clean["regime_final_wf"] != "burn_in"]
overlay_clean = overlay_clean.rename(columns={"regime_final_wf": "regime"})
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
banner("GENERATING CHART â€” Walk-Forward Regime Labels")

fig, axes = plt.subplots(4, 1, figsize=(16, 20), sharex=True)
fig.suptitle(
    "Person C â€” Week 3: Walk-Forward Regime Labels\n"
...
plot_wf(axes[0], wf_labels_gmm2, months, "GMM K=2 â€” Walk-Forward")
plot_wf(axes[1], wf_labels_gmm3, months, "GMM K=3 â€” Walk-Forward")
plot_wf(axes[2], wf_labels_hmm2, months, "HMM n=2 â€” Walk-Forward")
plot_wf(axes[3], final_labels_wf, months,
        f"FINAL MODEL ({best_name}) â€” Used in Week 4 Overlay")

axes[3].set_xlabel("Date", fontsize=9)
plt.tight_layout(rect=[0, 0, 1, 0.97])
plt.savefig(OUT_CHART, dpi=150, bbox_inches="tight")
plt.close()
print(f"  âœ…  {OUT_CHART}")


# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# DAYS 19â€“21: ADDITIONAL FACTOR ENGINEERING (support for Person B)
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
banner("DAYS 19â€“21 â€” Additional Factor Engineering (Support for Person B)")
...
# â”€â”€ Factor functions â€” paste these into src/factors.py â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
FACTOR_CODE = '''
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
with open(factor_file, "w", encoding="utf-8") as f:
    f.write(FACTOR_CODE)
print(f"\n  âœ…  {factor_file}  â† send this to Person B to merge into src/factors.py")


# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# WRITTEN SUMMARY FOR REPORT
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
banner("WRITTEN SUMMARY â€” Week 3 Regime Findings")
...
summary = f"""
REGIME MODEL â€” WEEK 3 WRITTEN SUMMARY (Person C)
=================================================
...
Walk-Forward Evaluation:
  ...
  {MIN_TRAIN_MONTHS} months of training data (January 2005 â€“ December 2009) was
...
Out-of-Sample Regime Distribution (Jan 2010 â€“ Dec 2024):
  Calm regime:   {calm_pct:.0f}% of months
  Crisis regime: {crisis_pct:.0f}% of months

Leverage Overlay Rules (locked for Week 4):
  calm   → 1.00x gross leverage, k_per_sector=5, quantiles=10% / 10%
  normal → 0.70x gross leverage, k_per_sector=3, quantiles=7% / 7%
  crisis → 0.40x gross leverage, k_per_sector=2, quantiles=4% / 4%

  Rationale: the overlay does not change which stocks are held by
  Person B's alpha model â€” only the overall size of the bet. During
...
Additional Factors Delivered to Person B:
  1. Short-term reversal  â€” negated prior-month return (Jegadeesh 1990)
  2. Accruals             â€” negated accruals ratio (Sloan 1996)
  3. Investment growth    â€” negated year-on-year asset growth (Cooper 2008)
  All three are cross-sectionally z-scored, consistent with Person B's
  existing 5-factor construction methodology.

Files for Week 4:
  results/regime_overlay_rules.csv        ← Person A: apply regime parameter columns
  results/regime_walkforward_labels.csv   ← full labels + features for reference
""".strip()
...
print(f"""
  âœ…  Walk-forward expanding window implemented (Days 15â€“16)
  âœ…  Every regime label is true out-of-sample
  âœ…  StandardScaler fitted only on training data at each step
  âœ…  Final model locked: {best_name}
  âœ…  Overlay rules defined and saved (Days 17â€“18)
  âœ…  3 new factors delivered to Person B (Days 19â€“21)
  âœ…  All outputs saved

  FILES TO SHARE WITH TEAM:
  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
  â”‚ File                                        â”‚ Who needs it          â”‚
  â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
  â”‚ {str(OUT_OVERLAY):<43} â”‚ Person A (Week 4)      â”‚
  â”‚ {str(OUT_WALKFORWARD):<43} â”‚ Person A (Week 4)      â”‚
  â”‚ {str(factor_file):<43} â”‚ Person B (merge now)   â”‚
  â”‚ {str(OUT_CHART):<43} â”‚ All (Friday sync)      â”‚
  â”‚ {str(OUT_SUMMARY):<43} â”‚ Report (Week 5)        â”‚
  â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜

  FRIDAY SYNC AGENDA:
  â€¢ Show regime_walkforward_chart.png â€” explain the dashed train/test line
  â€¢ Confirm Person A has regime_overlay_rules.csv and understands the
    regime parameter columns (leverage, k_per_sector, long_quantile, short_quantile)
  â€¢ Confirm Person B has merged new_factors_for_person_b.py into src/factors.py
  â€¢ Agree on Week 4 integration plan: Person A runs combined backtest
