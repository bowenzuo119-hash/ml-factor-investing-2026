...
- **Honest down-cap finding (GKX 2020 §IV.D):** on the strict rolling top-2,000 large-cap subset, FF5 α collapses to +1.8%/yr at t=0.96 (n.s.) — alpha lives in the small/mid-cap tail. **Cost-realism: we beat S&P on Sharpe up to 25 bps/side** (4× our 10 bps headline). At 10-15 bps (Frazzini-Israel-Moskowitz 2018 estimate is ~6 bps/side for AQR US-equity at $100B AUM) our Sharpe is +1.07-+1.14 vs S&P's +0.99. Capacity binds at very large AUM; regime overlay is universe-dependent (works on strict-S&P, net-zero on broad due to COVID monthly-lag).
