...
print(f"  âœ…  {OUT_WALKFORWARD}")

# â”€â”€ regime_overlay_rules.csv â€” clean version for Person A â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
print(f"  âœ…  {OUT_OVERLAY}  â† hand this to Person A")
...
Leverage Overlay Rules (locked for Week 4):
  calm   â†’ 1.00x gross leverage (no change to position sizes)
  normal â†’ 1.00x gross leverage (no change to position sizes)
  crisis â†’ 0.50x gross leverage (all position sizes halved)
...
Files for Week 4:
  {OUT_OVERLAY}        â† Person A: apply leverage_scalar column
  {OUT_WALKFORWARD}    â† full labels + features for reference
""".strip()
